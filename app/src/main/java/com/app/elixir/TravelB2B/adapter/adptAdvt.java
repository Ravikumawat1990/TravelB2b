...
public class adptAdvt extends RecyclerView.Adapter<adptAdvt.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        /*    Picasso.with(context).load(URLS.UPLOAD_IMG_URL + "" + dataSet.get(position).getHotel_pic())// Place holder image from drawable folder
                    .into(imageView);*/
            Log.i("TAG", "onBindViewHolder: " + URLS.UPLOAD_IMG_URL + "" + dataSet.get(position).getHotel_pic());
