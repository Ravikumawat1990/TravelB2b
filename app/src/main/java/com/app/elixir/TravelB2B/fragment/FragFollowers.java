...
import com.app.elixir.TravelB2B.adapter.adptfollowers;
...
public class FragFollowers extends Fragment {
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            ((ActionBarTitleSetter) context).setTitle(getString(R.string.followers));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.followers, container, false);
