...
public class FragPrivacyPolicys extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragprivectpolicy, container, false);
        thisActivity = getActivity();
        ((ActionBarTitleSetter) thisActivity).setTitle("Privacy Policy");
    ...
    private void sendRequest() {
        ...
        StringRequest stringRequest = new StringRequest(URLS.PRIVPOLICY,
